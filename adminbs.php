...
<body class="color">
   ...
   <center><a href="includes/booksearchlogout.php" class="text-warning"style="text-decoration:none;"><p style="font-size:20px;"><b>Another book</b></p></a></center>
      <?php
  }  

  
             else { 
              echo '    <h1 class="text-warning"><u><b>Search Book</b></u></h1>
             <form  style="text-align: left; margin-left: px; " method="post">
